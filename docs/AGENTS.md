...
6. Don't invent new mechanics, fields, or systems that aren't in `GDD.md`/`TDD.md`. If a task seems to need one, stop and add it to `TASKS.md` §5 (Open Questions Raised) instead of deciding unilaterally.
